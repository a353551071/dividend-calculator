...
export default function DividendGrowthCalc() {
  return (
    <Calculator
      fields={[
        { key: 'dividend', label: 'Current annual dividend per share', prefix: '$', defaultValue: 2, help: 'D0 (USD)' },
        { key: 'growth', label: 'Annual dividend growth rate', suffix: '%', defaultValue: 8, help: 'Historical compound growth rate' },
