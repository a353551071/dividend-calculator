...
//   https://www.dividendpayoutcalculator.com/<KEY>.txt (content == KEY).
//   IndexNow fetches that file to confirm domain ownership before it accepts the ping.
//
// Usage:
//   node scripts/indexnow.mjs https://www.dividendpayoutcalculator.com/blog/<slug> [more urls...]
//
// Behind a proxy / GFW where Node fetch cannot reach api.indexnow.org, use curl instead:
//   curl -X POST -H "Content-Type: application/json" \
//     -d "{\"host\":\"www.dividendpayoutcalculator.com\",\"key\":\"<KEY>\",\"keyLocation\":\"https://www.dividendpayoutcalculator.com/<KEY>.txt\",\"urlList\":[\"<URL>\"]}" \
